...
public class MainCuadradoMagico {
  public static void main(String[] args) {
    ...
    boolean esMagico = ComprobacionesCuadradoMagico.EsCuadradadoMagico(arrayBiNumeros);
    System.out.println("El cuadrado es magico: " + esMagico);
    arrayBiNumeros = arrayNuevosValores;
    esMagico = ComprobacionesCuadradoMagico.EsCuadradadoMagico(arrayBiNumeros);
